...
run_sheet = pygame.image.load('Battlemage Run.png').convert_alpha()
idle_sheet = pygame.image.load('Battlemage Idle.png').convert_alpha()
jump_sheet = pygame.image.load('Jump Foward Going Up.png').convert_alpha()
fall_sheet = pygame.image.load('Jump Foward Going Down.png').convert_alpha()
