...
run_sheet = pygame.image.load('runwithgun.png').convert_alpha()
idle_sheet = pygame.image.load('idle.png').convert_alpha()
jump_sheet = pygame.image.load('jump with gun.png').convert_alpha()
fall_sheet = pygame.image.load('falling down.png').convert_alpha()
...
animations = {
    'run': load_frames(run_sheet, total_frames=21),
    'idle': load_frames(idle_sheet, total_frames=12), 
    'jump': load_frames(jump_sheet, total_frames=21),
    'fall': load_frames(fall_sheet, total_frames=21)
}
current_state = 'idle'
flip_x = False
