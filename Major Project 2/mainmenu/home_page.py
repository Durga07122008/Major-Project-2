...
while game_active:
    ...
    if state == 1:
        ...
        Game_menu.start_clicked(selected_characters, selected_map)
        ...
        mapresult = Game_menu.settings_clicked()
        if mapresult == 0:
            state = 0
        else:
            selected_map = mapresult
            state = 0
