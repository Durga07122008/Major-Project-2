...
run_sheet = pygame.image.load('Owlet_Monster_Run_6.png').convert_alpha()
idle_sheet = pygame.image.load('Owlet_Monster_Idle_4.png').convert_alpha()
jump_sheet = pygame.image.load('Owlet_Monster_Jump.png').convert_alpha()
fall_sheet = pygame.image.load('Owlet_Monster_Fall.png').convert_alpha()
...
animations = {
    'run': load_frames(run_sheet, 6),
    'idle': load_frames(idle_sheet, 4), 
    'jump': load_frames(jump_sheet, 3),
    'fall': load_frames(fall_sheet, 3)
}
current_state = 'idle'
flip_x = False
...
char_rect = animations[current_state][0].get_rect(center=(400, 150))
