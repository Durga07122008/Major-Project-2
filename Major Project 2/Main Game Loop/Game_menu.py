...
Selectbutton = pygame.transform.scale(Selectbutton, (150, 61))
...
def start_clicked(characters, selected_map):
    result = None
    if selected_map == "Greenery":
        ingame_music.play(-1)
        result = MAIN.game_startmap1(characters)
    else:
        ingame_music.play(-1)
        result = MAIN2.game_startmap2(characters)
    pygame.display.set_mode((1000, 552))
    ingame_music.stop()    
    return result
...
def characters_clicked():
    ...
    char_rectp2 = animations[current_statep2][0].get_rect(center=(750, 250))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if p1_selected == None:
                    ...
                    if clickselectp1.rect.collidepoint(event.pos):
                        clickSound.play()
                        p1_selected = current_statep1
                ...
                if p2_selected == None:
                    ...
                    if clickselectp2.rect.collidepoint(event.pos):
                        clickSound.play()
                        p2_selected = current_statep2
                
                if p1_selected and p2_selected != None:
                    selected = [p1_selected, p2_selected]
                    return selected
...
def settings_clicked():
    ...
    clickright = Chara("Right", Rightbutton, (890, 450))
    clickselect = Chara("Select", Selectbutton, (500, 450))
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if clickselect.rect.collidepoint(event.pos):
                    ...
                    return current_map
        if current_map == "Greenery":
            current_image = map1image
        else:
            current_image = map2image

        screen.blit(mainmenu_background, (0,0))
        screen.blit(characterselectionbar, (30,20))
        screen.blit(current_image, (105, 80))
