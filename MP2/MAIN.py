...
P1 = Characters("PLAYER 1", player, (300, 200), "Classic", Gunsinven.Guns_Dictionary1)
P2 = Characters("PLAYER 2", player1, (500, 200), "Classic", Gunsinven.Guns_Dictionary2)
...
while Game_Active:
    ...
    for speed in Speed_Group:
        ...
        if P1.rect.colliderect(speed.rect):
            ...
            if pygame.time.get_ticks() - speed_timer1 > 5000:
                P1.v.x += P1.v.x / 2
            ...
            if pygame.time.get_ticks() - speed_timer2 > 5000:
                P2.v.x += P2.v.x / 2
